...
description: Databricks platform configuration including cluster setup, cost optimization, performance tuning, and workspace configuration. Use when configuring compute resources, optimizing costs, tuning performance, or setting up workspace infrastructure.
---
