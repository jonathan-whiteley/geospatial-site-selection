---
name: databricks-deployment-ops
description: Databricks deployment and operations including Asset Bundles, CI/CD pipelines, Terraform, Workflows orchestration, monitoring/observability, and Databricks Apps. Use when deploying code, setting up automation, managing infrastructure as code, orchestrating jobs, or building internal applications.
---
