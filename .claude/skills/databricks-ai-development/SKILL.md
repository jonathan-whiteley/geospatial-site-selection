---
name: databricks-ai-development
description: Databricks AI/GenAI development including LLM integration via Foundation Model API, RAG systems with Vector Search, Agent Bricks automation, agent frameworks (LangChain/LlamaIndex), LLM fine-tuning with LoRA/QLoRA, prompt engineering, and LLM evaluation. Use when building AI applications, implementing RAG, working with embeddings, creating agents, fine-tuning models, optimizing prompts, or evaluating LLM quality.
---
