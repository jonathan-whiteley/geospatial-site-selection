...
description: Databricks data engineering with Delta Lake, Delta Live Tables pipelines, medallion architecture (Bronze-Silver-Gold), Structured Streaming, Auto Loader, and optimization (Z-Ordering, liquid clustering). Use when building data pipelines, implementing incremental ingestion, applying data quality checks, optimizing tables, or designing medallion layers.
---
